    ...
    <>
      <header className='w-full py-2 border-b-2 bg-bcBluePrimary border-bcYellowPrimary flex justify-center'>
        <div className='w-full 2xl:w-2/3 h-full flex flex-row items-center align-center justify-between px-2 md:px-12'>
          ...
          <div className='mx-8 pr-10 2xl:pr-12 text-right text-white'>
            <span className='font-bold sm:text-sm text-xs'>Jean Smith</span>{' '}
            <FontAwesomeIcon className='h-3 inline-block' icon={faChevronDown} />
            <span className='block text-xs'>HLTH.FraserHealth</span>
          </div>
        </div>
      </header>
      <Navbar />
