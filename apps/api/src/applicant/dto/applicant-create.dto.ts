...
export class ApplicantCreateAPIDTO extends ApplicantCreateDTO {
  ...
  @ApiProperty({ description: 'Applicant Last Name', default: 'Bowill' })
  @IsString()
  @Length(1, 256)
  @IsOptional()
  last_name?: string;

  @ApiProperty({ description: 'Applicant profession', default: 'Nurse Practitioner' })
  @IsString()
  @IsNotEmpty()
  @Length(1, 256)
  profession!: string;
  ...
  @ApiPropertyOptional({
    description:
      'It is status start-date, sometime we might need to give past date as status start date.',
    type: 'string',
    format: 'date',
    pattern: 'YYYY-MM-DD',
  })
