...
import { IENApplicantUpdateDTO } from '@ien/common';

export class IENApplicantUpdateAPIDTO extends IENApplicantUpdateDTO {
  @ApiPropertyOptional({ description: 'Applicant Name', default: 'Mark Bowlill' })
  @IsString()
