export enum STATUS {
  ...
  BCCNM_PROVISIONAL_LICENCE_LPN = 'BCCNM Provisional Licence LPN',
  BCCNM_PROVISIONAL_LICENCE_RN = 'BCCNM Provisional Licence RN',
  BCCNM_PROVISIONAL_LICENCE_RPN = 'BCCNM Provisional Licence RPN',
  BCCNM_FULL_LICENCE_LPN = 'BCCNM Full Licence LPN',
  BCCNM_FULL_LICENCE_RN = 'BCCNM Full Licence RN',
  BCCMN_FULL_LICENCE_RPN = 'BCCNM Full Licence RPN',
...
export enum BCCNM_LICENCE_ENUM {
  BCCNM_PROVISIONAL_LICENCE_LPN = 'BCCNM Provisional Licence LPN',
  BCCNM_PROVISIONAL_LICENCE_RN = 'BCCNM Provisional Licence RN',
  BCCNM_PROVISIONAL_LICENCE_RPN = 'BCCNM Provisional Licence RPN',
  BCCNM_FULL_LICENCE_LPN = 'BCCNM Full Licence LPN',
